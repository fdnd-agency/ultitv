...
<p>
	...
	vijf <em>players</em> ingeladen maar dit aantal en het aantal <em>players</em> dat geskipt worden kunnen worden ingesteld.
</p>
...
<ul>
	<li>
		<a href="/api/v2/players">/api/v2/players</a>, selecteer 5 <em>players</em>.
	</li>
	<li>
		<a href="/api/v2/players?first=7">/api/v2/players?first=7</a> selecteer 7 <em>players</em>.
	</li>
	<li>
		<a href="/api/v2/players?first=20&skip=20">/api/v2/players?first=20&skip=20</a>, selecteer 20
